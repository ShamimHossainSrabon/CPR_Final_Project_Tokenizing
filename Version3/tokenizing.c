...
void tokenizing(void)
{
	...
	//
	// Print the boot message of the program. 	
	printf("*** Start of Sentences Phrases Demo ***\n");
	...
	//
	// Print the end message of the program. 
	printf("*** End of Sentences Phrases Demo ***\n\n");
}
